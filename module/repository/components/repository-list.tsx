  ...
  const disconnectMutation = useMutation({
    ...
    onSuccess: (result) => {
      if (result?.success) {
        ...
        toast.error(result?.error || "Failed to discount repository");
      }
    },
  });
        ...
        {!repositories || repositories.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm mt-2">
              Connect repositories from the Repositories page.
            </p>
          </div>
        ) : (
                ...
                <AlertDialog>
                  <AlertDialogTrigger>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="ml-4 text-destructive hover:text-destructive cursor-pointer"
                    >
